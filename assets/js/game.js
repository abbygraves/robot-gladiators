...
var fight = function(enemyName) {
  ...
  // ⬇︎ if player chooses to fight, then fight
  if (promptFight === "fight" || promptFight === "FIGHT") {
    // ⬇︎ subtract amount in playerAttack from enemyHealth
    ...
    // ⬇︎ subtract amount in enemyAttack from playerHealth
    ...
    // ⬇︎ if no (false), ask question again by running fight() again
    else {
      fight();
    }
    // ⬇︎ if player types something other than "fight" or "skip" in prompt
  } else {
